...
// e.g. 'txt,html,css,js'
$allowed_file_extensions = 'txt,html,php,js,css,jpg,png,pdf';

// Allowed file extensions for upload files
// e.g. 'gif,png,jpg,html,txt'
$allowed_upload_extensions = 'txt,html,php,js,css,jpg,png,pdf';
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="index.php" class="btn btn-primary btn-block mt-4" role="button">Kembali</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://tinyfilemanager.github.io/" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">CCP Programmers</a> &mdash;&mdash;<br />
                            &mdash;&mdash;
                            <a href="https://github.com/dtari18" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">Developed By Dwi A Lestari</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a href='index.php'><i class='fa fa-folder-o' aria-hidden='true'></i></a>";
